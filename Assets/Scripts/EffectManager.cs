...
public class EffectManager : MonoBehaviour
{
    ...
    {
        StartCoroutine(PlayerEffectDealayed(effectName, position, rotation, delay, duration));
    }

    private IEnumerator PlayerEffectDealayed(string effectName, Vector3 position, Quaternion rotation, float delay, float duration)
    {
