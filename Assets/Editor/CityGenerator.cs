...
public class CityGenerator : EditorWindow
{
   private int gridSizeX = 10;
    ...
    private float buildingSpace = 15;
    ...
    private void OnGUI()
    {
        GUILayout.Label("Simple City Genrerator", EditorStyles.boldLabel);

        gridSizeX = EditorGUILayout.IntField("Grid Size X", gridSizeX);
        gridSizeZ = EditorGUILayout.IntField("Grid Size Z", gridSizeZ);

        buildingSpace = EditorGUILayout.FloatField("Building Space", buildingSpace);
    ...
    private void CreateBuilding(Vector3 position , Transform parent)
    {
        ...
        building.transform.localScale = new Vector3(buildingSpace - roadWidth -1f, height, buildingSpace - roadWidth -1f);
    ...
    private void CreateRoad(Vector3 position , Transform parent)
    {
        ...
        road.transform.localScale = new Vector3(buildingSpace, 0.2f, buildingSpace);
